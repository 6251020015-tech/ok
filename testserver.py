...
# ===== Cấu hình =====
GEMINI_API_KEY = "AIzaSyD4_8mMY3DGEwinDVhQGsNQdZWRHOXak5c"
...
def main_loop():
    ...
    print("🤖 Bot đã khởi động. Hãy nhập câu hỏi vào V5 hoặc bật công tắc V6 để gửi dữ liệu cảm biến.")
